#
#  Be sure to run `pod spec lint CameraKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
Easy to work with, camera library for iOS written in pure Swift.
                   DESC
  ...
  s.source       = { :git => "https://github.com/CameraKit/camerakit-ios.git", :tag => "#{s.version}" }
  ...
  # s.public_header_files = "CameraKit/CameraKit/**/*.h"
